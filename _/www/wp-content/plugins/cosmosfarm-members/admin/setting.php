			...
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						...
						<p class="description">메뉴에 회원가입, 로그인 링크를 추가합니다. 메뉴가 없다면 먼저 생성해주세요. <a href="<?php echo admin_url('nav-menus.php')?>">메뉴 관리</a></p>
					</td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					<th scope="row"><label for="cosmosfarm_members_use_delete_account">계정 삭제</label></th>
					<td>
						...
						<p class="description">사용자가 직접 회원정보 페이지에서 계정을 삭제할 수 있도록 합니다. (탈퇴기능)</p>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"></th>
